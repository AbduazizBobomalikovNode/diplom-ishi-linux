...
//     let country_id = req.user.idcountry;
//     let profile = { ...req.user };
//     {
//         delete profile.idcountry;
//         delete profile.exp;
//         delete profile.limit;
//         delete profile.iat;
//         delete profile.licence;
//     }
//     let partners = await db.partner.getPartnerUser(user_id);
//     profile.partners = partners;

//     let myCard = await db.cardHasUser.getCardHasUserForUser(user_id);
//     profile.cards = myCard;

//     let Country = await db.country.getCountry(country_id);
//     profile.country = Country;

//     let documents = await db.document.getDocumentUser(user_id);
//     profile.documents = documents;

//     let devices = await db.device.getDeviceUser(user_id);
//     profile.devices = devices;

//     let payments = await db.payments.getPaymentsUser(user_id);
//     profile.payments = payments;

//     logger.action(db, "user  router ", req.originalUrl, req.user.id);
//     res.status(200).json(
//         profile
//     );
// })
...
//     }
//     let devices = await (await db).user.getUserDevice(id);
//     res.json(
//         devices
//     );
// })
